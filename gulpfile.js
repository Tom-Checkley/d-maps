...
gulp.task('watchFiles', function(){
	gulp.watch('dev/**/*', ['html', 'php', 'compileSass', 'images']);
});
...
gulp.task('default', ['html', 'php', 'minifyScripts', 'compileSass', 'images', 'browser-sync', 'watchFiles']);
